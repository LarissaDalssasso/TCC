...
<nav class="navbar navbar-expand-md fixed-top navbar-transparency navbar-light"
  ...
  <div class="col-lg-8 col-xl-8 offset-lg-1 mx-auto" style="padding-top: 8px">
    ...
    <p>
      <span style="color: rgb(255, 255, 255)">A diretora do espetáculo, Silvana Mara Cristóvão da Silva conta que
    ...
    <p>
      <span style="color: rgb(255, 255, 255)">Além de alunos de Teatro, a encenação contará com a participação de
    ...
    <div class="col">
      <div class="col" style="
        ...
        <div style="
                ...
                justify-content: center;
              ">
          <img class="imE" width="290" height="240" src="assets/img/tetra.jpg?h=6f03488909737fd2722d9fc00133553e" /><img
            class="imE" width="288" height="232" src="assets/img/tetra2.jpg?h=3694b10b05d1222cd7f1e4aeb9bdd53b" /><img
            class="imE" width="270" height="248" src="assets/img/tetra4.jpg?h=84460e399a80e7c2b397ed55e74586aa" />
        </div>
      </div>
    </div>
    <div>
      <div class="col">
        <a class="btn btn-outline-primary float-end" role="button" onclick="window.location.href='Evento3.php'" style="
          color: #ffffff;
          border: none;
          margin-top: 0px;
          padding-bottom: 0px;
          ...
          padding-left: 0px;
          margin-left: auto;
        "><strong>Festival da Canção de Ibirama retorna na programação do
            Weihnachtsmarkt -&gt;</strong></a>
      </div>
    </div>
