    ...
    <div class="container">
        ...
        <form action="editar_funcionario.php?id=<?php echo $id; ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="area" name="area" value="<?php echo $funcionario['area']; ?>" required>
            </div>
            <div class="form-group">
                <label for="senha">Senha:</label>
                <input type="password" class="form-control" id="senha" name="senha" value="<?php echo $funcionario['senha']; ?>" required>
            </div>
            <div class="form-group">
                <label for="genero">Gênero:</label>
                <select class="form-control" id="genero" name="genero" required>
                    <option value="Masculino" <?php if ($funcionario['genero'] == 'Masculino') echo 'selected'; ?>>Masculino</option>
                    <option value="Feminino" <?php if ($funcionario['genero'] == 'Feminino') echo 'selected'; ?>>Feminino</option>
                    <option value="Outro" <?php if ($funcionario['genero'] == 'Outro') echo 'selected'; ?>>Outro</option>
                </select>
            </div>
